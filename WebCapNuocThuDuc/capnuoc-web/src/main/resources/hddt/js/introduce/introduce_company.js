	...
	_gridMain.kendoGrid({
		dataSource: new kendo.data.DataSource({
			transport: {
				read: {
					type: 'POST',
                    url: ROOT_PATH + '/admin/main/introduce/search',
                    dataType: 'json',
...
//		height: kendoGridHeight,
		...
		dataBound: function(e) {
			...
			$("#fIntroCompany").find('button[data-action="detail"], button[data-action="hotnews"]').prop('disabled', true);
			$("#fIntroCompany").find('button[data-action="edit"]').prop('disabled', true);
			$("#fIntroCompany").find('button[data-action="active"]').prop('disabled', true);
			$("#fIntroCompany").find('button[data-action="de-active"]').prop('disabled', true);
			$("#fIntroCompany").find('button[data-action="delete"]').prop('disabled', true);
		},
	});
	...
	_gridMain.find('table[role="grid"]').find('tbody').delegate('tr', 'click', function(e){
		...
		$("#fIntroCompany").find('button[data-action="detail"], button[data-action="hotnews"]').prop('disabled', false);
		...
		$("#fIntroCompany").find('button[data-action="edit"]').prop('disabled', !('N' == isActive) );
		$("#fIntroCompany").find('button[data-action="active"]').prop('disabled', !('N' == isActive) );
		$("#fIntroCompany").find('button[data-action="de-active"]').prop('disabled', 'N' == isActive );
		$("#fIntroCompany").find('button[data-action="delete"]').prop('disabled', !('N' == isActive) );
	});
	
	$("#fIntroCompany").find('button[data-action]').click(function (event) {
...
function getDataSearch(){
	var dataPost = {};
	dataPost['title'] = $("#fIntroCompany").find('#title').val();
	return dataPost;
}