	...
	_gridMain.kendoGrid({
		dataSource: new kendo.data.DataSource({
			transport: {
				read: {
					type: 'POST',
                    url: ROOT_PATH + '/admin/main/logo/search',
                    dataType: 'json',
...
//		height: kendoGridHeight,
		...
		dataBound: function(e) {
			...
			$("#fLogo").find('button[data-action="detail"], button[data-action="hotnews"]').prop('disabled', true);
			$("#fLogo").find('button[data-action="edit"]').prop('disabled', true);
			$("#fLogo").find('button[data-action="active"]').prop('disabled', true);
			$("#fLogo").find('button[data-action="de-active"]').prop('disabled', true);
			$("#fLogo").find('button[data-action="delete"]').prop('disabled', true);
		},
	});
	...
	_gridMain.find('table[role="grid"]').find('tbody').delegate('tr', 'click', function(e){
		...
		$("#fLogo").find('button[data-action="detail"], button[data-action="hotnews"]').prop('disabled', false);
		...
		$("#fLogo").find('button[data-action="edit"]').prop('disabled', !('N' == isActive) );
		$("#fLogo").find('button[data-action="active"]').prop('disabled', !('N' == isActive) );
		$("#fLogo").find('button[data-action="de-active"]').prop('disabled', 'N' == isActive );
		$("#fLogo").find('button[data-action="delete"]').prop('disabled', !('N' == isActive) );
	});
	
	$("#fLogo").find('button[data-action]').click(function (event) {
...
function getDataSearch(){
	var dataPost = {};
	dataPost['title'] = $("#fLogo").find('#title').val();
	return dataPost;
}