	...
	_gridMain.kendoGrid({
		dataSource: new kendo.data.DataSource({
			transport: {
				read: {
					type: 'POST',
                    url: ROOT_PATH + '/admin/main/juridical/search',
                    dataType: 'json',
...
//		height: kendoGridHeight,
		...
		dataBound: function(e) {
			...
			$("#fJuridical").find('button[data-action="detail"], button[data-action="hotnews"]').prop('disabled', true);
			$("#fJuridical").find('button[data-action="edit"]').prop('disabled', true);
			$("#fJuridical").find('button[data-action="active"]').prop('disabled', true);
			$("#fJuridical").find('button[data-action="de-active"]').prop('disabled', true);
			$("#fJuridical").find('button[data-action="delete"]').prop('disabled', true);
		},
	});
	...
	_gridMain.find('table[role="grid"]').find('tbody').delegate('tr', 'click', function(e){
		...
		$("#fJuridical").find('button[data-action="detail"], button[data-action="hotnews"]').prop('disabled', false);
		...
		$("#fJuridical").find('button[data-action="edit"]').prop('disabled', !('N' == isActive) );
		$("#fJuridical").find('button[data-action="active"]').prop('disabled', !('N' == isActive) );
		$("#fJuridical").find('button[data-action="de-active"]').prop('disabled', 'N' == isActive );
		$("#fJuridical").find('button[data-action="delete"]').prop('disabled', !('N' == isActive) );
	});
	
	$("#fJuridical").find('button[data-action]').click(function (event) {
...
function getDataSearch(){
	var dataPost = {};
	dataPost['title'] = $("#fJuridical").find('#title').val();
	return dataPost;
}