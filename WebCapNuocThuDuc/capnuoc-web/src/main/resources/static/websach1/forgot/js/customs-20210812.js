$(function () {
  ...
  $(window).ready(i),
    ...
    $('.sidebartoggler').on('click', function () {
     ...
     $('.custom-field__textbox').on('focusout', function () {
if ($(this).val().length > 0) {
      $(this).addClass('focus-ses')
    } else {
      $(this).removeClass('focus-ses')
    }
  })
     $('.custom-field__select').on('focusout', function () {
if ($(this).val().length > 0) {
      $(this).addClass('focus-ses')
    } else {
      $(this).removeClass('focus-ses')
...
$('select').on('select2:select', function (e) {
   $($('.select2')).addClass('focus-ses')
});
 $('select').on('select2:unselect', function (e) {
         $($('.select2')).removeClass('focus-ses')      
    });


$.fn.materializeInputsss = function(selectors) {
