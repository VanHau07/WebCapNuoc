package vn.webcapnuoc.hddt.controller.user.gioithieu;
...
@RequestMapping("/")
public class GioiThieuController extends AbstractController{
	@Autowired private RestAPIUtility restAPIUtility;
	private static final Logger log = LogManager.getLogger(GioiThieuController.class);
	@Autowired RestAPIUtility restAPI;
	@RequestMapping(value = {"/gioi-thieu" }, method = {RequestMethod.GET, RequestMethod.POST})
