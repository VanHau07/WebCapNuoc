...
import vn.webcapnuoc.hddt.admin.dao.SlideAdminDAO;
...
@Repository
@Transactional
public class SlideAdminImpl extends AbstractDAO implements SlideAdminDAO {
	private static final Logger log = LogManager.getLogger(SlideAdminImpl.class);
	@Autowired
	...
	public MsgRsp crud(JSONRoot jsonRoot) throws Exception {
		...
		try {
			...
			case Constants.MSG_ACTION_CODE.CREATED:		
				...
				mongoTemplate.getCollection("Slide").insertOne(docTmp);
			...
			case Constants.MSG_ACTION_CODE.MODIFY:
				...
				cursor = mongoTemplate.getCollection("Slide").find(docFind);
				...
				docTmp = mongoTemplate.getCollection("Slide").findOneAndUpdate(
						docTmp
						, new Document("$set", 
			...
			case Constants.MSG_ACTION_CODE.CHECK_HOTNEWS:
				...
				switch (actionCode) {
				case Constants.MSG_ACTION_CODE.ACTIVE:
					mongoTemplate.getCollection("Slide").findOneAndUpdate(
							docFind
							, new Document("$set", 
	...
	public MsgRsp detail(JSONRoot jsonRoot, String _id) throws Exception {
		...
		Document docTmp = null;
		Iterable<Document> cursor = mongoTemplate.getCollection("Slide").find(docFind);
